var App = function () {
	...
	var globalAjaxFunc = function (type, url, data, successCallback, params) {
	    console.log('接口:' + url);
	...
	return {
	    ...
	    // global ajax
        globalAjax: function (type, url, data, successCallback, params) {
            globalAjaxFunc(type, url, data, successCallback, params);
        },
    };
}();
(function (a, b) {
